<?php
/**
 * Ce fichier est le controleur principal coté utilisateur, c'est lui qui gère l'interface utilisateur.
 *
 * @category  Globalken 
 * @package   Administration
 * @author    Team GlobalCS - Alex Ngongang
 * Date: 21-08-2023
 * 
 */
...
//
// Get language (default: french)
//
$Language = new PMF_Language($faqConfig);
$LANGCODE = $Language->setLanguage($faqConfig->get('main.languageDetection'), $faqConfig->get('main.language'));
// Preload English strings
require_once 'lang/language_fr.php';
...
// Found an action request? // Vous avez trouvé une demande d'action ?
...
//Sélectionner le template pour l'action executée
...
//
// Set right column //Définir la colonne de droite
//
// Check in any tags with at least one entry exist
//Archiver toutes les balises avec au moins une entrée existente
//
...
// Charger les fichiers template et definit les variables de template
//
...
$tplMainPage = array(
    ...
    'baseHref'             => $faqSystem->getSystemUri($faqConfig), //Cette variable recupere l'url saisie depuis le navigateur
    ...
    if ('main' == $action && $faqConfig->get('search.useAjaxSearchOnStartpage')) {
        ...
        $tpl->parseBlock(
            ...
            array(
             ...
             'showkeyword'   => $faq->getkeyword()
            // 'showkeyword'   => $category->getCategories()
